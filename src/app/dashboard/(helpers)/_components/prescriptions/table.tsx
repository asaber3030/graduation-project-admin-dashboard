                ...
                <TableRow key={`doctor-row-${prescription.id}`}>
                  ...
                  <TableCell>
                    <Link
                      ...
                      href={adminRoutes.doctors.view(prescription.doctor.id)}
                    >
                  ...
                  <TableCell>
                    <Link
                      className='text-blue-500'
                      href={adminRoutes.doctors.view(prescription.patient.id)}
                    >
                  ...
                  <TableCell className='text-right space-x-2'>
                    <LinkBtn
                      icon={Eye}
                      href={adminRoutes.prescriptions.view(prescription.id)}
                      variant='outline'
                    >
                      View
                    </LinkBtn>
                    <LinkBtn
                      icon={Cog}
                      href={adminRoutes.prescriptions.update(prescription.id)}
                      variant='blue'
                    >
                      Update
                    </LinkBtn>
