...
export const AdminEmployeesTable = ({ hasNextPage, searchParams, data }: Props) => {
  return (
    <>
      <FilterAll
        searchParams={searchParams}
            ...
            <TableBody>
              {data.map((employee) => (
                <TableRow key={`employee-row-${employee.id}`}>
                  ...
                  <TableCell>
                    <Link href={adminRoutes.employees.view(employee.id)} className='text-blue-600'>
                      @{employee.username}
                    </Link>
                  </TableCell>
                  ...
                  <TableCell>
                    <Link
                      href={adminRoutes.departments.view(employee.departmentId)}
                  ...
                  <TableCell>
                    <Link
                      href={adminRoutes.hospitals.view(employee.hospitalId)}
                      className='text-blue-600'
                    >
