  ...
  return (
    <div className=''>
      <AdminPageTitle title={pageTitle}>
        ...
        <LinkBtn href={adminRoutes.medicine.update(medicineId)} variant='blue' icon={Cog}>
          Update
        </LinkBtn>
        ...
        <Card>
          ...
          <CardContent className='grid gap-4'>
            ...
            <div>
              ...
              <Link href={adminRoutes.inventories.view(medicine.inventory.id)}>
      ...
      <div className='mt-6 print:hidden'>
        <LinkBtn href={adminRoutes.medicine.root} variant='outline'>
