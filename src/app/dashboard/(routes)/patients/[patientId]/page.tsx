      ...
      <section>
        ...
        <section className='grid xl:grid-cols-5 grid-cols-1 gap-2'>
          <PatientResourceBox
            ...
            label='Prescriptions'
            href={adminRoutes.patients.patientPrescriptions(patientId)}
            image={resourcesIcons.prescriptions}
          />
          <PatientResourceBox
            num={counts.medications}
            label='Medications'
            href={adminRoutes.patients.patientMedications(patientId)}
            image={resourcesIcons.medicine}
          />
          <PatientResourceBox
            num={counts.vaccinations}
            label='Vaccinations'
            href={adminRoutes.patients.patientVaccinations(patientId)}
